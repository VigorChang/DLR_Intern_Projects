...
module soc_mm_interconnect_1 (
		...
		input  wire        write_master_sgdma_Clock_reset_reset_bridge_in_reset_reset,         //         write_master_sgdma_Clock_reset_reset_bridge_in_reset.reset
		input  wire [31:0] write_master_sgdma_Data_Write_Master_address,                       //                         write_master_sgdma_Data_Write_Master.address
		output wire        write_master_sgdma_Data_Write_Master_waitrequest,                   //                                                             .waitrequest
		input  wire [7:0]  write_master_sgdma_Data_Write_Master_byteenable,                    //                                                             .byteenable
		input  wire        write_master_sgdma_Data_Write_Master_write,                         //                                                             .write
		input  wire [63:0] write_master_sgdma_Data_Write_Master_writedata,                     //                                                             .writedata
	...
	wire          write_master_sgdma_data_write_master_translator_avalon_universal_master_0_waitrequest;   // write_master_sgdma_Data_Write_Master_agent:av_waitrequest -> write_master_sgdma_Data_Write_Master_translator:uav_waitrequest
	wire   [63:0] write_master_sgdma_data_write_master_translator_avalon_universal_master_0_readdata;      // write_master_sgdma_Data_Write_Master_agent:av_readdata -> write_master_sgdma_Data_Write_Master_translator:uav_readdata
	wire          write_master_sgdma_data_write_master_translator_avalon_universal_master_0_debugaccess;   // write_master_sgdma_Data_Write_Master_translator:uav_debugaccess -> write_master_sgdma_Data_Write_Master_agent:av_debugaccess
	wire   [31:0] write_master_sgdma_data_write_master_translator_avalon_universal_master_0_address;       // write_master_sgdma_Data_Write_Master_translator:uav_address -> write_master_sgdma_Data_Write_Master_agent:av_address
	wire          write_master_sgdma_data_write_master_translator_avalon_universal_master_0_read;          // write_master_sgdma_Data_Write_Master_translator:uav_read -> write_master_sgdma_Data_Write_Master_agent:av_read
	wire    [7:0] write_master_sgdma_data_write_master_translator_avalon_universal_master_0_byteenable;    // write_master_sgdma_Data_Write_Master_translator:uav_byteenable -> write_master_sgdma_Data_Write_Master_agent:av_byteenable
	wire          write_master_sgdma_data_write_master_translator_avalon_universal_master_0_readdatavalid; // write_master_sgdma_Data_Write_Master_agent:av_readdatavalid -> write_master_sgdma_Data_Write_Master_translator:uav_readdatavalid
	wire          write_master_sgdma_data_write_master_translator_avalon_universal_master_0_lock;          // write_master_sgdma_Data_Write_Master_translator:uav_lock -> write_master_sgdma_Data_Write_Master_agent:av_lock
	wire          write_master_sgdma_data_write_master_translator_avalon_universal_master_0_write;         // write_master_sgdma_Data_Write_Master_translator:uav_write -> write_master_sgdma_Data_Write_Master_agent:av_write
	wire   [63:0] write_master_sgdma_data_write_master_translator_avalon_universal_master_0_writedata;     // write_master_sgdma_Data_Write_Master_translator:uav_writedata -> write_master_sgdma_Data_Write_Master_agent:av_writedata
	wire    [3:0] write_master_sgdma_data_write_master_translator_avalon_universal_master_0_burstcount;    // write_master_sgdma_Data_Write_Master_translator:uav_burstcount -> write_master_sgdma_Data_Write_Master_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                                       // rsp_mux:src_valid -> write_master_sgdma_Data_Write_Master_agent:rp_valid
	wire  [145:0] rsp_mux_src_data;                                                                        // rsp_mux:src_data -> write_master_sgdma_Data_Write_Master_agent:rp_data
	wire          rsp_mux_src_ready;                                                                       // write_master_sgdma_Data_Write_Master_agent:rp_ready -> rsp_mux:src_ready
	wire    [0:0] rsp_mux_src_channel;                                                                     // rsp_mux:src_channel -> write_master_sgdma_Data_Write_Master_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                               // rsp_mux:src_startofpacket -> write_master_sgdma_Data_Write_Master_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                                 // rsp_mux:src_endofpacket -> write_master_sgdma_Data_Write_Master_agent:rp_endofpacket
	...
	wire  [145:0] cmd_mux_src_data;                                                                        // cmd_mux:src_data -> hps_0_f2h_sdram0_data_agent:cp_data
	...
	wire          write_master_sgdma_data_write_master_agent_cp_valid;                                     // write_master_sgdma_Data_Write_Master_agent:cp_valid -> router:sink_valid
	wire  [145:0] write_master_sgdma_data_write_master_agent_cp_data;                                      // write_master_sgdma_Data_Write_Master_agent:cp_data -> router:sink_data
	wire          write_master_sgdma_data_write_master_agent_cp_ready;                                     // router:sink_ready -> write_master_sgdma_Data_Write_Master_agent:cp_ready
	wire          write_master_sgdma_data_write_master_agent_cp_startofpacket;                             // write_master_sgdma_Data_Write_Master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          write_master_sgdma_data_write_master_agent_cp_endofpacket;                               // write_master_sgdma_Data_Write_Master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	) write_master_sgdma_data_write_master_translator (
		.clk                    (clk_0_clk_clk),                                                                           //                       clk.clk
		.reset                  (write_master_sgdma_Clock_reset_reset_bridge_in_reset_reset),                              //                     reset.reset
		.uav_address            (write_master_sgdma_data_write_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (write_master_sgdma_data_write_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (write_master_sgdma_data_write_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (write_master_sgdma_data_write_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (write_master_sgdma_data_write_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (write_master_sgdma_data_write_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (write_master_sgdma_data_write_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (write_master_sgdma_data_write_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (write_master_sgdma_data_write_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (write_master_sgdma_data_write_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (write_master_sgdma_data_write_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (write_master_sgdma_Data_Write_Master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (write_master_sgdma_Data_Write_Master_waitrequest),                                        //                          .waitrequest
		.av_byteenable          (write_master_sgdma_Data_Write_Master_byteenable),                                         //                          .byteenable
		.av_write               (write_master_sgdma_Data_Write_Master_write),                                              //                          .write
		.av_writedata           (write_master_sgdma_Data_Write_Master_writedata),                                          //                          .writedata
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) write_master_sgdma_data_write_master_agent (
		.clk                   (clk_0_clk_clk),                                                                           //       clk.clk
		.reset                 (write_master_sgdma_Clock_reset_reset_bridge_in_reset_reset),                              // clk_reset.reset
		.av_address            (write_master_sgdma_data_write_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (write_master_sgdma_data_write_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (write_master_sgdma_data_write_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (write_master_sgdma_data_write_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (write_master_sgdma_data_write_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (write_master_sgdma_data_write_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (write_master_sgdma_data_write_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (write_master_sgdma_data_write_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (write_master_sgdma_data_write_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (write_master_sgdma_data_write_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (write_master_sgdma_data_write_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (write_master_sgdma_data_write_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (write_master_sgdma_data_write_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (write_master_sgdma_data_write_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (write_master_sgdma_data_write_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (write_master_sgdma_data_write_master_agent_cp_ready),                                     //          .ready
	...
	soc_mm_interconnect_1_router router (
		.sink_ready         (write_master_sgdma_data_write_master_agent_cp_ready),         //      sink.ready
		.sink_valid         (write_master_sgdma_data_write_master_agent_cp_valid),         //          .valid
		.sink_data          (write_master_sgdma_data_write_master_agent_cp_data),          //          .data
		.sink_startofpacket (write_master_sgdma_data_write_master_agent_cp_startofpacket), //          .startofpacket
		.sink_endofpacket   (write_master_sgdma_data_write_master_agent_cp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                                               //       clk.clk
		.reset              (write_master_sgdma_Clock_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
	...
	soc_mm_interconnect_1_router_001 router_001 (
